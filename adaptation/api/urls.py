...
from adaptation.api.views import AdaptationCreateAPIView, AdaptationUpdateAPIView, FacultyListView, ScienceListView, StudentClassAPIView, StudentClassCreateAPI
...
urlpatterns = [
     ...
     path('student_class_list', StudentClassAPIView.as_view(), name="student_class_list_api"),
