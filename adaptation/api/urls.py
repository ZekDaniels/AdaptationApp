...
from adaptation.api.views import AdaptationCreateAPIView, AdaptationUpdateAPIView, FacultyListView, ScienceListView, StudentClassCreateAPI, StudentClassListAPIView
